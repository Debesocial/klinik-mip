...
class PermintaanMakananController extends Controller
{
     ...
     */
    public function datapermintaanmakanan()
    {
        $permintaanmakanan = PermintaanMakanan::all();


        return view('petugas.makanan.data_permintaan_makanan', compact('permintaanmakanan'));
    }
