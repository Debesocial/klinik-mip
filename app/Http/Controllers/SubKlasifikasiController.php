...
class SubKlasifikasiController extends Controller
{
    ...
    public function tambahsubklasifikasi(Request $request)
    {
        ...
        return redirect('/sub/klasifikasi')->with('message', 'Berhasil Menambahkan Sub Klasifikasi Penyakit!');
    }
    ...
    function changesubklasifikasi(Request $request, $id) {
        ...
        return redirect('/sub/klasifikasi')->with('message', 'Berhasil Mengubah Sub Klasifikasi Penyakit!');
    }
