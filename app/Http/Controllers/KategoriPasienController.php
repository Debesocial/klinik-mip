...
class KategoriPasienController extends Controller
{
    ...
    public function tambahkategoripasien(Request $request)
    {
        ...
        return redirect('/kategori/pasien')->with('success', 'Berhasil Menambahkan Data Ketegori Pasien');
    }
    ...
    function changekategoripasien(Request $request, $id) {
        ...
        return redirect('/kategori/pasien')->with('success', 'Berhasil Mengubah Data Kategori Pasien');
    }
