...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div>Nama Pasien : <a href="#"
                        onclick="tampilModalPasien({{ json_encode($jalan->pasien) }})">{{ $jalan->pasien->nama_pasien }}
                                        ...
                                        @if (is_array(json_decode($jalan->dokumen)) && count(json_decode($jalan->dokumen)))
                                            <ol>
                                                @foreach (json_decode($jalan->dokumen) as $dokumen)
                                                    <li> <a href="{{ asset('pemeriksaan/rawatjalan/' . $dokumen) }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($jalan->persetujuan_tindakan)
                                            <a href="{{ asset('pemeriksaan/persetujuan_tindakan/' . $jalan->persetujuan_tindakan) }}"
                                                target="_blank" rel="noopener noreferrer">:
                                                {{ $jalan->persetujuan_tindakan }}</a>
                                        @else
