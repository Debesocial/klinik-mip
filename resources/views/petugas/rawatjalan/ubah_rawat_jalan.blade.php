                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        @if ($rawat_jalan->dokumen)
                                            <a href="{{asset('pemeriksaan/rawatjalan/'.$rawat_jalan->dokumen)}}" target="blank">{{$rawat_jalan->dokumen}}</a>
                                        @else
                                        ...
                                        <input type="hidden" name="old_dokumen" value="{{$rawat_jalan->dokumen}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row mb-2">
