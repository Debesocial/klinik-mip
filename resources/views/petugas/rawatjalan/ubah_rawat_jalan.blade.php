...
@section('js')
    ...
    <script>
        ...
        function lanjut2() {
            ...
            var inputs = ['tanggal_berobat', 'nama_penyakit_id', 'anamnesis', 'tinggi_badan', 'berat_badan', 'suhu_tubuh', 'tekanan_darah', 'saturasi_oksigen', 'denyut_nadi', 'laju_pernapasan',  'status_lokalis'];
