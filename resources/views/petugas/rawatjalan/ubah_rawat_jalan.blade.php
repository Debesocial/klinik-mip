        ...
        <div class="card-body">
            <div id="stepper2" class="bs-stepper">
                ...
                <div class="bs-stepper-content">
                    <form id="form-add-jalan" class="form needs-validation" action="/ubah/rawat/jalan/{{$rawat_jalan->id}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" name="anamnesis" id="anamnesis" class="form-control" value="{{$rawat_jalan->anamnesis}}">
                                        {!!validasi('Anamnesis')!!}
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-control" value="{{$rawat_jalan->tinggi_badan}}">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="berat_badan" id="berat_badan" class="form-control" value="{{$rawat_jalan->berat_badan}}">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="suhu_tubuh" id="suhu_tubuh" class="form-control" value="{{$rawat_jalan->suhu_tubuh}}">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="saturasi_oksigen" id="saturasi_oksigen" class="form-control" value="{{$rawat_jalan->saturasi_oksigen}}">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="tekanan_darah" id="tekanan_darah" class="form-control" value="{{$rawat_jalan->tekanan_darah}}">
                                                <span class="input-group-text" id="basic-addon1">/</span>
                                                <input type="number" name="tekanan_darah_per" id="tekanan_darah_per" class="form-control" value="{{$rawat_jalan->tekanan_darah_per}}">
                                                <span class="input-group-text" id="basic-addon1">mmHg</span>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="denyut_nadi" id="denyut_nadi" class="form-control" value="{{$rawat_jalan->denyut_nadi}}">
                                            <span class="input-group-text" id="basic-addon1">/</span>
                                            <input type="number" name="denyut_nadi_menit" id="denyut_nadi_menit" class="form-control" value="{{$rawat_jalan->denyut_nadi_menit}}">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="laju_pernapasan" id="laju_pernapasan" class="form-control" value="{{$rawat_jalan->laju_pernapasan}}">
                                            <span class="input-group-text" id="basic-addon1">/</span>
                                            <input type="number" name="laju_pernapasan_menit" id="laju_pernapasan_menit" class="form-control" value="{{$rawat_jalan->laju_pernapasan_menit}}">
                                            <span class="input-group-text" id="basic-addon1">menit</span>
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                        <label for="" class="form-label">Pemeriksaan Penunjang</label>
                                        <input type="text" name="pemeriksaan_penunjang" id="pemeriksaan_penunjang" class="form-control" value="{{$rawat_jalan->pemeriksaan_penunjang}}">
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        <label for="" class="form-label">Dokumentasi Pendukung</label> <b><small class="text-warning">**File maksimal berukuran 20MB</small></b><br>
                                        @if ($rawat_jalan->dokumen)
                                        <ol>
                                            @foreach (json_decode($rawat_jalan->dokumen) as $dokumen)
                                                <li> <a href="{{asset('pemeriksaan/jalan/'.$dokumen)}}" target="blank">{{$dokumen}}</a> <button onclick="removeItem(this)" type="button" class="btn btn-sm btn-outline-danger border-0"><i class="bi bi-trash"></i></button></li>
                                            @endforeach
                                        </ol>
                                        @else
                                        ...
                                        <input type="hidden" name="old_dokumen" id="old_dokumen" value="{{$rawat_jalan->dokumen}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row mb-2">
                        ...
                        <div id="test-nl-3" class="content">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    {!! validasi('Ukuran file','terlalu besar')!!}
                                    <input type="hidden" name="old_persetujuan_tindakan" value="{{$rawat_jalan->persetujuan_tindakan}}">
                                </div>
                                <div class="col-md-6 p-auto">
                                    @if ($rawat_jalan->persetujuan_tindakan)
                                        <a href="{{asset('pemeriksaan/persetujuan_tindakan/'.$rawat_jalan->persetujuan_tindakan)}}" target="blank">Lihat surat persetujuan tindakan <i class="bi bi-box-arrow-up-right"></i></a>
                                    @endif
                                </div>
                            </div>
...
@section('js')
    ...
    <script>
        ...
        function lanjut2() {
            ...
            var inputs = ['tanggal_berobat', 'nama_penyakit_id', 'anamnesis', 'tinggi_badan', 'berat_badan', 'suhu_tubuh', 'tekanan_darah', 'saturasi_oksigen', 'denyut_nadi', 'denyut_nadi_menit', 'laju_pernapasan', 'laju_pernapasan_menit', 'status_lokalis'];
    ...
    <script>
        ...
        var tindakan = {!! $rawat_jalan->tindakan !!};
