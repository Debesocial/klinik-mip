                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control"
                                                 no_rekam medis="name" value="" placeholder="Tanggal Mulai Rawat Inap" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control"
                                                 no_rekam medis="name" value="" placeholder="Tanggal Berakhirnya Rawat Inap" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control"
                                                 no_rekam medis="name" value="" placeholder="ID Rawat Inap" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control"
                                                 name="" value="" placeholder="Nomor Induk Karyawan" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="diagnosa" class="form-control"
                                                 name="diagnosa" value="" placeholder="Diagnosa" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control"
                                                 name="" value="" placeholder="Sub Klasifikasi Penyakit" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control"
                                                 name="" value="" placeholder="Klasifikasi Penyakit" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control"
                                                 name="" value="" placeholder="Status" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="page-heading">
                                        ...
                                        <div class="list-group list-group-horizontal-sm mb-1 text-center" role="tablist" style="width: 100%">
                                            <a class="list-group-item list-group-item-action active" id="list-dokter-list" data-bs-toggle="list"
                                                href="#list-dokter" role="tab">Pemeriksaan Instruksi Dokter</a>
                                            <a class="list-group-item list-group-item-action" id="list-perawat-list" data-bs-toggle="list"
                                                href="#list-perawat" role="tab">Pemeriksaan Intervensi Keperawatan</a>
                                
                                            <a class="list-group-item list-group-item-action" id="list-makanan-list" data-bs-toggle="list"
                                                href="#list-makanan" role="tab">Permintaan Makanan</a>
                                            <a class="list-group-item list-group-item-action" id="list-tandavital-list" data-bs-toggle="list"
                                                href="#list-tandavital" role="tab">Pemantaauan Tanda Vital</a>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal">
                                        <div class="form-body table-responsive">
                                            <table class="table table-responsive" id="TABLE_4">
                                                <thead>
                                                    <tr>
                                                        <th>Tanggal Pemeriksaan</th>
                                                        <th>ID Pemeriksaan</th>
