                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="select_pasien_id" class="form-select" required>
                                            ...
                                            @foreach ($pasien_id as $key => $pas)
                                                <option value="{{ $key }}"
                                                    {{ $pas->id == $selected_pasien ? 'selected' : '' }}>
...
@section('js')
    ...
    <script>
        ...
        function lanjut2() {
            ...
            var inputs = ['mulai_rawat', 'anamnesis', 'tinggi_badan', 'berat_badan', 'suhu_tubuh', 'tekanan_darah',
                'tekanan_darah_per', 'saturasi_oksigen', 'denyut_nadi', 'laju_pernapasan', 'status_lokalis'
            ];
            ...
            if (validasiPemeriksaan && validasiManyFile(20000, files) && validated) {
                stepper2.next()
            }
        }
