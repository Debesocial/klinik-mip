            ...
            <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="/add/rawat/inap" method="post" enctype='multipart/form-data'>
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input id="mulai_rawat" type="date" class="form-control"
                                                            name="mulai_rawat" placeholder="Mulai Rawat Inap" required >
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input id="berakhir_rawat" type="date" class="form-control"
                                                            name="berakhir_rawat" placeholder="Berakhirnya Rawat Inap" required >
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
