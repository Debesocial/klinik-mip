    ...
    <div class="card-body">
        <div class="row">
            <div class="col text-center">
                <h5>Hasil MCU Awal - {{ $mcuawal->id_mcu_awal }}</h5>
            </div>
        </div>
        <div class="row">
            <div class="col-10">
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="ttl">: {{ $mcuawal->pasien->tempat_lahir.', '. $mcuawal->pasien->tanggal_lahir }}</td>
                        </tr>
                        <tr>
                            <th>Alamat</th>
...
@section('js')
    <script> 
        if (window.performance) { 
            ...
            if (window.performance.navigation && window.performance.navigation.type == window.performance.navigation.TYPE_BACK_FORWARD){        
