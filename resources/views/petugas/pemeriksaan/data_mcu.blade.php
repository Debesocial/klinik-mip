...
<div class="list-group list-group-horizontal-sm mb-3 text-center" role="tablist"
    ...
    <a class="list-group-item list-group-item-action rounded-end rounded-pill active"
        id="list-mcu-awal" data-bs-toggle="list" href="#mcu-awal"
        role="tab">MCU Awal
    </a>
                            ...
                            <table class="table" id="TABLE_1">
                                ...
                                <tbody>
                                    @foreach ($mcuawal as $awal)
                                        <tr>
                                            <td class="text-center">{{ date('d-m-Y H:i', strtotime($awal->created_at)) }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                    <a href="/mcu/{{ $awal->id }}" class="btn btn-outline-secondary" title="Ubah data alkes"><i class="bi bi-eye-fill"></i></a>
                                                    <a href="/ubah_mcu/awal/{{ $awal->id }}" class="btn btn-outline-secondary" title="Ubah data alkes"><i class="bi bi-pencil-square"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                        <div class="buttons" width="100px">
                            <button onclick="tampilModalRawatInap('/instruksi_dokter/form_tambah/','Formulir Pemeriksaan Instruksi Dokter')" class="btn m-0 btn-sm btn-success rounded-pill">
                                <i class="bi bi-plus-circle"></i>
