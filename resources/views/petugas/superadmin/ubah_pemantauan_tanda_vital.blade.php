...
<div class="page-heading">
    ...
    <div class="page-heading">
        ...
        <form class="form form-horizontal" action="/ubah/pemantauan/tandavital/{{$pemantauan->id}}" method="post" enctype="multipart/form-data">
            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <select class="choices form-select" name="skala_nyeri" id="skala_nyeri" required>
                                                        <option value="{{   $pemantauan->skala_nyeri  }}">{{ $pemantauan->skala_nyeri }}</option>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <select class="choices form-select" name="bp" id="bp" required>
                                                        <option value="{{   $pemantauan->bp  }}">{{ $pemantauan->bp }}</option>
                                                        @foreach ($hasilpemantauan as $hasil)
                                                        <option value="{{ $hasil->nama_pemantauan }}" {{ $hasil->nama_pemantauan == $pemantauan->nama_pemantauan ? 'selected' : '' }}>{{ $hasil->nama_pemantauan }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <select class="choices form-select" name="temp" id="temp" required>
                                                        <option value="{{   $pemantauan->temp  }}">{{ $pemantauan->temp }}</option>
                                                        @foreach ($hasilpemantauan as $hasil)
                                                        <option value="{{ $hasil->nama_pemantauan }}" {{ $hasil->nama_pemantauan == $pemantauan->nama_pemantauan ? 'selected' : '' }}>{{ $hasil->nama_pemantauan }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <select class="choices form-select" name="rr" id="rr" required>
                                                        <option value="{{   $pemantauan->rr  }}">{{ $pemantauan->rr }}</option>
                                                        @foreach ($hasilpemantauan as $hasil)
                                                        <option value="{{ $hasil->nama_pemantauan }}" {{ $hasil->nama_pemantauan == $pemantauan->nama_pemantauan ? 'selected' : '' }}>{{ $hasil->nama_pemantauan }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <select class="choices form-select" name="saturasi_oksigen" id="saturasi_oksigen" required>
                                                        <option value="{{   $pemantauan->saturasi_oksigen  }}">{{ $pemantauan->saturasi_oksigen }}</option>
                                                        @foreach ($hasilpemantauan as $hasil)
                                                        <option value="{{ $hasil->nama_pemantauan }}" {{ $hasil->nama_pemantauan == $pemantauan->nama_pemantauan ? 'selected' : '' }}>{{ $hasil->nama_pemantauan }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <textarea name="keterangan"  id="keterangan" class="form-control" cols="30" rows="10">{{$pemantauan->keterangan}}</textarea>
                                                </div>
                                                <div class="col-md-6">
                                                </div>
