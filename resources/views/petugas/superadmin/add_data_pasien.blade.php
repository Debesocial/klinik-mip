                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="choices form-select" name="lainnya" id="lainnya" required  onchange="yesnoCheck_lainnya(this);">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="choices form-select">
                                                ...
                                                <option value="{{ $divi->id }}">{{ $divi->nama_divisi_pasien }}</option>
                                                @endforeach
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="umur" class="form-control"
                                                name="umur" placeholder="Masukkan tempat lahir">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-check-input" type="radio" name="alergi" id="alergi"> Tidak
                                            <label for="">
                                            <input class="form-check-input" type="radio" name="alergi" id="alergi" checked> Ya
                                        </label>
                                    </div>
                                    <div class="col-md-6">
                                        </div> 
                                        ...
                                        <div class="col-md-4 form-group">
                                            <input class="form-check-input" type="radio" name="hamil_menyusui" id="hamil_menyusui"> Tidak
                                            <label for="">
                                            <input class="form-check-input" type="radio" name="hamil_menyusui" id="hamil_menyusui" checked> Ya
                                            </label>
                                        </div>
                                        <div class="col-md-6">
                                            </div>
