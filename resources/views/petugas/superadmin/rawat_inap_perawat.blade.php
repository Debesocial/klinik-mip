...
@section('title', 'Rawat Inap Perawat')
...
<div class="page-heading">
    ...
    <div class="list-group list-group-horizontal-sm mb-1 text-center" role="tablist" style="width: 50%">
                                ...
                                <a class="list-group-item list-group-item-action" id="list-tindakan-list"
                                    ...
                                    <a class="list-group-item list-group-item-action" id="list-catatan-list"
                                    data-bs-toggle="list" href="#list-catatan" role="tab">Catatan</a>
                            </div>
    ...
    <div class="tab-pane fade" id="list-catatan" role="tabpanel"
                                    aria-labelledby="list-catatan-list">
                                    <section id="basic-horizontal-layouts">
        <div class="row match-height">
        <div class="col-12">
                <div class="card">
