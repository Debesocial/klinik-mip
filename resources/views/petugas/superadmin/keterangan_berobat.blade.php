                                        ...
                                        <form class="form form-horizontal" action="/keterangan/berobat" method="post">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="pekerjaan" class="form-control" name="pekerjaan" placeholder="Masukkan pekerjaan" disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="perusahaan" class="form-control" name="perusahaan" placeholder="Masukkan perusahaan" disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="divisi" class="form-control" name="divisi" placeholder="Masukkan divisi" disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="jabatan" class="form-control" name="jabatan" placeholder="Masukkan jabatan" disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
