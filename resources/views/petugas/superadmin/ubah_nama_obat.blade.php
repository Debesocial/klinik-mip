...
@section('breadcrumb', 'ubah_nama_obat')
@section('container')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" action="/ubah/nama/obat/{{ $namaobat->id }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="hari">Nama Obat <b class="color-red">*</b></label>
                                            <input type="text" class="form-control" name="nama_obat" placeholder="Masukkan nama obat" value="{{ $namaobat['nama_obat'] }}" required>
                                        </div>
                                    </div>
                                    <div class="col-12"><br>
