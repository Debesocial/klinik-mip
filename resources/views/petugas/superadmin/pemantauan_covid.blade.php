                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <textarea type="text" id="jenis_pemeriksaan"
                                                            class="form-control" name="jenis_pemeriksaan"> </textarea>
                                                    </div>
                                                    <div class="col-md-5">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <textarea type="text" id="hasil_laboratorium"
                                                            class="form-control" name="hasil_laboratorium"
                                                            required> </textarea>
                                                    </div>
                                                    <div class="col-md-2">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="asal" class="form-control" name="asal"
                                                            placeholder="Masukkan kabupaten/kota Asal" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
