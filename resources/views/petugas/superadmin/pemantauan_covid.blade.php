                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="no_rekam_medis" class="form-control" name="no_rekam_medis" placeholder="No Rekam Medis" required disabled>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="nama_pasien" class="form-control" name="nama_pasien" placeholder="Nama Pasien" required disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="date" id="tanggal_lahir" class="form-control" name="tanggal_lahir" required disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="umur" class="form-control" name="umur" placeholder="Umur" required disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="pekerjaan" class="form-control" name="pekerjaan" placeholder="Pekerjaan" required disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="perusahaan" class="form-control" name="perusahaan" placeholder="Perusahaan" required disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="divisi" class="form-control" name="divisi" placeholder="Perusahaan" required disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <textarea type="text" id="spo2" class="form-control" name="spo2"> </textarea>
                                                    </div>
                                                    <div class="col-md-5">
                                                    </div>
                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 form-group">
                                                        <input type="date" id="pengguna_alat" class="form-control" name="pengguna_alat">
                                                    </div>
                                                    <div class="col-md-8">
                                                    </div> <br><br><br>
                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 form-group">
                                                        <input type="date" id="tanggal_perjalanan" class="form-control" name="tanggal_perjalanan">
                                                    </div>
                                                    <div class="col-md-8">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <input type="text" id="kota_asal" class="form-control" name="kota_asal" placeholder="Masukkan kabupaten/kota Asal">
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
