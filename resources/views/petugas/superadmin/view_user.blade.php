                        ...
                        <table class="table table-borderless" id="" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <input type="text" id="senin" class="form-control" name="senin" value="{{ $user->jadwal->senin }}" readonly>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="selasa" class="form-control" name="selasa" value="{{ $user->jadwal->selasa }}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center">Rabu</th>
                                    <td>
                                        <input type="text" id="rabu" class="form-control" name="rabu" value="{{ $user->jadwal->rabu }}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center">Kamis</th>
                                    <td>
                                        <input type="text" id="kamis" class="form-control" name="kamis" value="{{ $user->jadwal->kamis }}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center">Jumat</th>
                                    <td>
                                        <input type="text" id="jumat" class="form-control" name="jumat" value="{{ $user->jadwal->jumat }}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center">Sabtu</th>
                                    <td>
                                        <input type="text" id="sabtu" class="form-control" name="sabtu" value="{{ $user->jadwal->sabtu }}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center">Minggu</td>
                                    <td>
                                        <input type="text" id="minggu" class="form-control" name="minggu" value="{{ $user->jadwal->minggu }}" readonly>
                                    </td>
