...
<div class="page-heading">
    <div class="page-title">
        ...
        <div class="list-group list-group-horizontal-sm mb-1 text-center" role="tablist" style="width: 60%">
            <a class="list-group-item list-group-item-action active" id="list-sunday-list" data-bs-toggle="list"
                href="#list-sunday" role="tab">Data Pasien</a>
            <a class="list-group-item list-group-item-action" id="list-monday-list" data-bs-toggle="list"
                href="#list-monday" role="tab"> Riwayat Penggunaan Obat-Obatan</a>
        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="/periksa/narkoba" method="post"
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <select id="pasien_id" class="choices form-select"
                                                            ...
                                                            @foreach ($pasien_id as $pas)
                                                                <option
                                                                    value="{{ $pas['id'] }}|{{ $pas['nama_pasien'] }}|{{ $pas['NIK'] }}|{{ $pas['tempat_lahir'] }}|{{ $pas['tanggal_lahir'] }}|{{ $pas['alamat'] }}|{{ $pas['pekerjaan'] }}| {{ $pas->perusahaan->nama_perusahaan_pasien }}|{{ $pas->divisi->nama_divisi_pasien }}|{{ $pas->jabatan->nama_jabatan }}|{{ $pas['jenis_kelamin'] }}|{{ $pas['telepon'] }}|{{ $pas['email'] }}">
                                                                    {{ $pas['id_rekam_medis'] }} -
