...
<section id="multiple-column-form">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <form class="form" action="/ubah/data/user/{{$user->id }}" method="post" onsubmit="showLoader()">
                        @csrf
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="telp" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="telp" value="{{ $user['telp'] }}" maxlength="13" required />
                            </div>
                        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>Jadwal dari tanggal <b>{{tanggal($user->jadwal->created_at)}}</b> sampai sekarang.</p>
                    <form action="/ubah-jadwal/{{$user->id}}" method="post" onsubmit="showLoader()">
                        @csrf
