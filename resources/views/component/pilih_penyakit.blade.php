<div class="input-group rounded-pill mb-3">
    ...
    <input type="text" id="cari_penyakit" class="form-control rounded-pill" placeholder="Cari penyakit" onkeyup="cariPenyakit(this)" aria-label="Search" aria-describedby="search-addon" />
</div>
    ...
    function cariPenyakit(field) {
        ...
        $.ajax({
            ...
            success: function (data) {
                let html = ``; 
                if (data.code == 404) {
                    html = `<div class="my-5 text-center"><h3 class="text-secondary">${data.msg}</h3></div>`;
