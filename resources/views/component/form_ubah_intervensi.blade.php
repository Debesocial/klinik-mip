@php
    ...
    $url = '/intervensi/ubah/' . $intervensi->id;
    $rawat_inap = $intervensi->id_rawat_inap;
        ...
        <div class="container">
            <form action="{{ $url }}" method="POST" id="formInstruksi">
                    ...
                    <div class="row justify-content-between">
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-10">
                                    <input type="text" name="anamnesis" id="anamnesis"
                                        class="form-control form-control-sm" value="{{ $intervensi->anamnesis }}">
                                    {!! validasi('Anamenesis') !!}
                                </div>
                            </div>
                            <div class="mb-2 row">
                                ...
                                <div class="col-8">
                                    <input type="number" name="tinggi_badan" id="tinggi_badan"
                                        class="form-control form-control-sm" value="{{ $intervensi->tinggi_badan }}">
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-8">
                                    <input type="number" name="berat_badan" id="berat_badan"
                                        class="form-control form-control-sm" value="{{ $intervensi->berat_badan }}">
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-8">
                                    <input type="number" name="suhu_tubuh" id="suhu_tubuh"
                                        class="form-control form-control-sm" value="{{ $intervensi->suhu_tubuh }}">
                                    {!! validasi('Suhu tubuh') !!}
                                </div>
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-4">
                                    <input type="number" name="tekanan_darah" id="tekanan_darah"
                                        class="form-control form-control-sm" value="{{ $intervensi->tekanan_darah }}">
                                ...
                                <div class="col-4">
                                    <input type="number" name="tekanan_darah_per" id="tekanan_darah_per"
                                        class="form-control form-control-sm" value="{{ $intervensi->tekanan_darah_per }}">
                                    {!! validasi('Tekanan darah') !!}
                                </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <input type="text" name="pemeriksaan_penunjang" id="pemeriksaan_penunjang"
                                            class="form-control form-control-sm"
                                            value="{{ $intervensi->pemeriksaan_penunjang }}">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <textarea name="catatan_pemeriksaan" id="catatan_pemeriksaan" class="form-control form-control-sm">{{ $intervensi->catatan_pemeriksaan }}</textarea>
                                        {!! validasi('Catatan') !!}
                                    </div>
                                </div>
                            </div>
                ...
                <div id="test-nl-2" class="content">
                    <x-form-tindakan :tindakan="$tindakan" :alatkesehatan="$alatkesehatan" :selectedTindakan="$intervensi->tindakan" :dokumen="false"/>
                    <div class="d-flex justify-content-between">
                ...
                <div id="test-nl-3" class="content">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Catatan <b class="text-danger">*</b></label>
                                <textarea name="catatan" id="catatan" class="form-control">{{ $intervensi->catatan }}</textarea>
                                {!! validasi('Catatan') !!}
                            </div>
                        </div>
                    </div>
...
@php
    $selectedTindakan = $intervensi->tindakan??json_encode([]);
