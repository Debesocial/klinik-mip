                    ...
                    <div class="row ">
                        <div class="col-lg-8 offset-lg-2 col-md-12 co-12">
                            <div class="home-slider">
                                <div class="hero-text">
                                    <h5 class="wow fadeInUp" data-wow-delay=".3s">Start to learning Today</h5>
                                    <h1 class="wow fadeInUp" data-wow-delay=".5s">Innovation Paradise<br> For Students
                                    </h1>
                                    <p class="wow fadeInUp" data-wow-delay=".7s">Lorem Ipsum is simply dummy text of the
                                        printing and typesetting <br> industry. Lorem Ipsum has been the industry's
                                        standard
                    ...
                    <div class="row ">
                        <div class="col-lg-8 offset-lg-2 col-md-12 co-12">
                            <div class="home-slider">
                                <div class="hero-text">
                                    <h5 class="wow fadeInUp" data-wow-delay=".3s">Start to learning Today</h5>
                                    <h1 class="wow fadeInUp" data-wow-delay=".5s">Your Ideas Will Be <br> Heard &
                                        Supported</h1>
                                    <p class="wow fadeInUp" data-wow-delay=".7s">Lorem Ipsum is simply dummy text of the
                                        printing and typesetting <br> industry. Lorem Ipsum has been the industry's
                                        standard
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="course-details.html"><img src="public_assets/images/courses/courses-1.jpg"
                                        alt="#"></a>
                                <p class="price">$180</p>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".4s">
                            <div class="course-image">
                                <a href="course-details.html"><img src="public_assets/images/courses/courses-2.jpg"
                                        alt="#"></a>
                                <p class="price">$200</p>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".6s">
                            <div class="course-image">
                                <a href="course-details.html"><img src="public_assets/images/courses/courses-3.jpg"
                                        alt="#"></a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="course-details.html"><img src="public_assets/images/courses/courses-4.jpg"
                                        alt="#"></a>
                                <p class="price">$299</p>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".4s">
                            <div class="course-image">
                                <a href="course-details.html"><img src="public_assets/images/courses/courses-5.jpg"
                                        alt="#"></a>
                                <p class="price">$150</p>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".6s">
                            <div class="course-image">
                                <a href="course-details.html"><img src="public_assets/images/courses/courses-6.jpg"
                                        alt="#"></a>
                                <p class="price">$250</p>
                            </div>
                            <div class="content">
            ...
            <div class="row ">
                <div class="col-lg-6 offset-lg-3 col-md-12 col-12">
                    ...
                    <div class="subscribe-text wow fadeInUp" data-wow-delay=".2s">
                        <form action="https://demo.graygrids.com/themes/edugrids/mail/mail.php" method="get"
            ...
            <div class="row">
                    ...
                    <div class="single-news custom-shadow-hover wow fadeInUp" data-wow-delay=".2s">
                        <div class="image">
                            <a href="blog-single-sidebar.html"><img class="thumb"
                                    src="public_assets/images/blog/blog-grid1.jpg" alt="#"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news custom-shadow-hover wow fadeInUp" data-wow-delay=".4s">
                        <div class="image">
                            <a href="blog-single-sidebar.html"><img class="thumb"
                                    src="public_assets/images/blog/blog-grid2.jpg" alt="#"></a>
                        </div>
                        <div class="content-body">
                            <div class="meta-data">
                                <ul>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news custom-shadow-hover wow fadeInUp" data-wow-delay=".6s">
                        <div class="image">
                            <a href="blog-single-sidebar.html"><img class="thumb"
                                    src="public_assets/images/blog/blog-grid3.jpg" alt="#"></a>
                        </div>
                        <div class="content-body">
                            <div class="meta-data">
                                <ul>
                            ...
                            <ul>
                                <li>
                                    <a href="blog-single-sidebar.html"><img
                                            src="public_assets/images/blog/footer-news1.jpg" alt="#">
                                ...
                                <li>
                                    <a href="blog-single-sidebar.html"><img
                                            src="public_assets/images/blog/footer-news2.jpg" alt="#">
